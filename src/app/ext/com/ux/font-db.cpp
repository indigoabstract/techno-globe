...
const std::vector<font_glyph>& font_db::get_glyph_vect(shared_ptr<ux_font> ifont, const std::string& itext)
{
	std::wstring text = string2wstring(itext);
	return p->get_glyph_vect(ifont, text);
}

const std::vector<font_glyph>& font_db::get_glyph_vect(shared_ptr<ux_font> ifont, const std::wstring& itext)
{
	return p->get_glyph_vect(ifont, itext);
}
...
glm::vec2 font_db::get_text_dim(shared_ptr<ux_font> ifont, const std::wstring& itext)
{
